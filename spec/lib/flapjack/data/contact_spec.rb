...
describe Flapjack::Data::Contact, :redis => true do
  ...
  let(:general_notification_rule_data) {
    {:entities           => [],
     ...
     :time_restrictions  => [],
     :unknown_media      => [],
     :warning_media      => ['email', 'sms', 'slack', 'sms_twilio', 'sms_nexmo', 'jabber', 'pagerduty', 'sns', 'pushover'],
     :critical_media     => ['email', 'sms', 'slack', 'sms_twilio', 'sms_nexmo', 'jabber', 'pagerduty', 'sns', 'pushover'],
     :unknown_blackhole  => false,
     :warning_blackhole  => false,
     :critical_blackhole => false}
  }
